...
- Ensina: seguir entidades, coletar drop e consultar descrição de item.
...
#### MQ_C1_012_OS_PORTOES_DE_ACORDELOT
...
#### MQ_C1_014_PARTITURA_DE_APRENDIZ
...
#### MQ_C1_017_DOMINAR_O_PROPRIO_SOM
...
#### MQ_C1_019_MERCADO_E_RESSONANCIA
...
#### MQ_C1_020_CONVERGENCIA_DOS_ECOS
...
#### MQ_C1_021_UMA_MELODIA_PARA_PIPPO
...
#### MQ_C1_024_O_SEQUESTRO_DE_PIPPO
...
#### MQ_C1_025_O_MENINO_QUE_NUNCA_EXISTIU
...
#### MQ_C1_027_A_MELODIA_INCOMPLETA
...
#### MQ_C1_028_DOIS_ROSTOS_DISSONANTES
...
#### MQ_C1_030_A_TESTEMUNHA_DISSONANTE
...
#### MQ_C1_031_PERMISSAO_PARA_PARTIR
...
#### MQ_C1_032_O_PAIS_ENTRE_FREQUENCIAS
...
- Missões 6–10: coleta, inventário e síntese.
- Missões 11–17: mapa, progressão, build, armas, equipamentos, Skills e passivas.
- Missões 18–21: personagens, catálogo, loja, gacha e vínculo final com Pippo.
- Missões 22–25: prova integrada dos sistemas durante o sequestro.
- Missões 26–32: investigação livre com menos instruções e mais autonomia.
...
3. Implementar as missões 1–10 como vertical slice do onboarding.
4. Validar coleta, inventário e síntese sem softlocks.
5. Implementar progressão/build das missões 11–17.
6. Projetar e implementar o gacha antes de incluir a missão 20.
7. Implementar vínculo, sequestro e mudança global de memória.
8. Construir estrada/fronteira até Dissonia e o encerramento.
9. Fazer uma passagem completa solo e outra cooperativa.
